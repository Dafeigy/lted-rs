...
export const encodedblock_data: (a: number) => any;
export const lubytransformencoder_new: (a: any, b: number, c: bigint) => number;
...
export const encode_file_blocks: (a: any, b: number, c: bigint, d: number) => any;
